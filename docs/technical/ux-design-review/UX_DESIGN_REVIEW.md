...
2. **Deux boutons « Enregistrer » de portée différente, non explicitée.** « Changer le mot de passe » (dans sa carte) et « Enregistrer les parametres » en bas de page — ce dernier ne sauvegarde **que** la fenêtre de projection et les cycles mensuels. Un utilisateur qui modifie la projection puis clique sur « Changer le mot de passe » perd ses réglages sans le moindre avertissement.
