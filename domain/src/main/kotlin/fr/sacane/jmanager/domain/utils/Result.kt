...
enum class ResultState (val code: Int){
    ...
    CSV_EMPTY_FILE(6001),
    CSV_INVALID_HEADER(6002),
    CSV_MISSING_COLUMNS(6003),
    CSV_EXTRA_COLUMNS(6004),
    CSV_MALFORMED_LINE(6005),
    CSV_INVALID_DATE_FORMAT(6006),
    CSV_INVALID_AMOUNT_FORMAT(6007),
    CSV_MISSING_REQUIRED_FIELD(6008),
    CSV_BOTH_AMOUNTS_FILLED(6009),
    CSV_NO_AMOUNT_FILLED(6010),
    CSV_NEGATIVE_AMOUNT(6011),
    CSV_POSSIBLE_COLUMN_SWAP(6012);
