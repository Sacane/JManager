...
object FakeFactory {
    ...
    val confirmVirtualTransactionService = ConfirmVirtualTransactionService(transactionRepository, sessionManager, bookletRepository, inMemoryTrackerRepository, inMemoryTagRepository, manager)
